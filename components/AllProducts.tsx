...
const products = [
  ...
  { id: 9, name: "Carrots", variant: "Vegetables", price: "₦55", oldPrice: "₦60", image: "/images/carrot.jpg" },
    { id: 10, name: "Pepper", variant: "Vegetable", price: "₦60", oldPrice: "₦89.99", image: "/images/pepper.jpg" },
    { id: 11, name: "Garlic", variant: "Vegetable", price: "₦30", oldPrice: "₦70", image: "/images/garlic.jpg" },
    { id: 12, name: "Fish", variant: "Livestock", price: "₦23", oldPrice: "₦45", image: "/images/fish.jpg" },
];
  ...
  return (
    ...
    ${
      ...
      <p className="text-gray-500 mt-2">
        Discover all fresh farm produces and livestocks at unbeatable prices,
